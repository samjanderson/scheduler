...
describe("Application", () => {
  ...
  it("loads data, edits an interview and keeps the spots remaining for Monday the same", async () => {
    ...
    // 4. Check that Archie Cohen is the current value of the form element (text should still be there)
    ...
    // 7. Wait for saving to finish so appointment displays the new students name
